...
class AdaptivePageScaffold extends StatelessWidget {
  const AdaptivePageScaffold(
      {@required this.title,
        @required this.child,
        @required this.scaffoldActionIcon,
  ...
  final String title;
  final Widget child;
  final Widget scaffoldActionIcon;
    ...
    if (_isIOS) {
      return AdaptiveTextTheme(
        child: CupertinoPageScaffold(
          navigationBar: CupertinoNavigationBar(
            ...
            trailing: scaffoldActionIcon != null ? scaffoldActionIcon : null,
            backgroundColor: Color(0xFF6591FF),
      ...
      return AdaptiveTextTheme(
        child: Scaffold(
          ...
          body: child,
          floatingActionButton: floatingActionButtonIcon != null
              ? FloatingActionButton(
              onPressed: null, child: floatingActionButtonIcon)
              : null,
        ),
      );
    }
